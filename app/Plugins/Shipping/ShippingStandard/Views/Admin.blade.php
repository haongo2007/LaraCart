          ...
          <div class="box-header with-border">
              ...
              <div class="box-tools">
                  <div class="btn-group pull-right" style="margin-right: 5px">
                      <a href="{{ bc_route_admin('admin_plugin',['code'=>'Shipping']) }}" class="btn  btn-flat btn-default" title="List"><i class="fa fa-list"></i><span class="hidden-xs"> {{trans('admin.back_list')}}</span></a>
                  </div>
              </div>
          </div>
            <!-- /.box-header -->
                ...
                <tbody>
                    <tr>
                      <td>
                        ...
                        data-type="text" 
                        data-pk="{{ $data['id'] }}" 
                        data-url="{{ bc_route('shippingstandard.updateConfig') }}" 
