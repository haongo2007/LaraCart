...
use DB;
class BackupController extends RootAdminController
{
    ...
    {
        $tableInfo = DB::connection(BC_CONNECTION)
            ->table('INFORMATION_SCHEMA.TABLES')
            ->select(['table_name', 'table_rows', 'data_length'])
            ->where('TABLE_SCHEMA', config('database.connections.'.BC_CONNECTION.'.database'))
