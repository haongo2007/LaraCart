...
class ProductPropertyController extends RootAdminController
{
    ...
    public function index()
    {
        $data = [
            ...
            'subTitle' => '',
            'icon' => 'fa fa-indent',
            'urlDeleteItem' => bc_route_admin('admin_product_property.delete'),
            'removeList' => 0, // 1 - Enable function delete list item
            'buttonRefresh' => 0, // 1 - Enable button refresh
            'buttonSort' => 0, // 1 - Enable button sort
            'css' => '', 
            'js' => '',
            'url_action' => bc_route_admin('admin_product_property.create'),
        ];
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[] = [
                ...
                'name' => $row['name'] ?? 'N/A',
                'action' => '
                    <a href="' . bc_route_admin('admin_product_property.edit', ['id' => $row['id']]) . '"><span title="' . trans('product_property.admin.edit') . '" type="button" class="btn btn-flat btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
        ...
        $data['layout'] = 'index';
        return view($this->templatePathAdmin.'Product.property')
            ->with($data);
    }
...
public function edit($id)
{
    ...
    $data = [
        ...
        'css' => '', 
        'js' => '',
        'url_action' => bc_route_admin('admin_product_property.edit', ['id' => $product_property['id']]),
