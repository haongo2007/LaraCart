...
class MenuController extends RootAdminController
{
    ...
    public function index()
    {
        $data = [
            ...
            'url_action' => bc_route_admin('admin_menu.create'),
            'urlDeleteItem' => bc_route_admin('admin_menu.delete'),
 ...
 */
    public function edit($id)
    {
        ...
        $data = [
            ...
            'menu' => $menu,
            'treeMenu' => (new AdminMenu)->getTree(),
            'url_action' => bc_route_admin('admin_menu.edit', ['id' => $menu['id']]),
            'title_form' => '<i class="fa fa-edit" aria-hidden="true"></i> ' . trans('menu.admin.edit'),
        ];
        $data['urlDeleteItem'] = bc_route_admin('admin_menu.delete');
        $data['id'] = $id;
        $data['layout'] = 'edit';
        return view($this->templatePathAdmin.'screen.list_menu')
            ->with($data);
