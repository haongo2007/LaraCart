...
class DataShopSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_banner')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_banner_type')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_layout_position')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_link')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_shipping_standard')->insert(
            [
                ['fee' => 20, 'shipping_free' => 10000],
            ]
        );

        DB::connection(config('const.LC_CONNECTION'))->table('shop_product_category')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_product_image')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_product_attribute')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_product_property')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_product_build')->insert(
            [
            ]
        );

        DB::connection(config('const.LC_CONNECTION'))->table('shop_product_group')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_product_promotion')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_attribute_group')->insert(
            [
                ['name' => 'Color', 'status' => '1',  'type' => 'radio'],
                ['name' => 'Size', 'status' => '1',  'type' => 'select'],
            ]
        );
        DB::connection(config('const.LC_CONNECTION'))->table('shop_brand')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_currency')->insert(
            [
                ['id' => '1', 'name' => 'USD Dola', 'code' => 'USD', 'symbol' => '$', 'exchange_rate' => '1', 'precision' => '0', 'symbol_first' => '1', 'thousands' => ',', 'status' => '1', 'sort' => '0', 'store_id' => '0'],
                ['id' => '2', 'name' => 'USD Dola', 'code' => 'USD', 'symbol' => '$', 'exchange_rate' => '1', 'precision' => '0', 'symbol_first' => '1', 'thousands' => ',', 'status' => '1', 'sort' => '0', 'store_id' => '1'],
                ['id' => '3', 'name' => 'VietNam Dong', 'code' => 'VND', 'symbol' => '₫', 'exchange_rate' => '20', 'precision' => '0', 'symbol_first' => '0', 'thousands' => ',', 'status' => '1', 'sort' => '1', 'store_id' => '1'],
            ]
        );

        DB::connection(config('const.LC_CONNECTION'))->table('shop_order_status')->insert(
            [
                ['id' => '1', 'name' => 'New'],
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_page')->insert(
            [
                ['id' => '1', 'image' => '', 'alias' => 'about', 'status' => '1', 'store_id' => 1],
            ]
        );
        DB::connection(config('const.LC_CONNECTION'))->table('shop_page_description')->insert(
            [
                ['page_id' => '1', 'lang' => 'us', 'title' => 'About', 'keyword' => '', 'description' => '', 'content' => '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-2.png" style="width: 262px; height: 262px; float: right; margin: 10px;" /></p>
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    ',],
                ['page_id' => '1', 'lang' => 'vn', 'title' => 'Giới thiệu', 'keyword' => '', 'description' => '', 'content' => '<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<img alt="" src="/data/product/product-2.png" style="width: 262px; height: 262px; float: right; margin: 10px;" /></p>
    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    ',],
            ]
        );

        DB::connection(config('const.LC_CONNECTION'))->table('shop_payment_status')->insert(
            [
                ['id' => '1', 'name' => 'Unpaid'],
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_shipping_status')->insert(
            [
                ['id' => '1', 'name' => 'Not sent'],
                ['id' => '2', 'name' => 'Sending'],
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_supplier')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_customer')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_customer_address')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_country')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('api_connection')->insert(
            [
                ['description' => 'Demo api connection', 'apiconnection' => 'appmobile', 'apikey' => uniqid(), 'status' => 0],
            ]
        );

        DB::connection(config('const.LC_CONNECTION'))->table('shop_tax')->insert(
            [
                ['id' => '1', 'name' => 'Tax default (10%)', 'value' => 10],
            ]
        );

        DB::connection(config('const.LC_CONNECTION'))->table('shop_weight')->insert(
            [
        ...
        DB::connection(config('const.LC_CONNECTION'))->table('shop_length')->insert(
            [
