<template>
  <el-row :gutter="40" class="panel-group">
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" :class="{active : active_el == 1}" @click="handleSetLineChartData('newCustomers',1)">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" :class="{active : active_el == 2}" @click="handleSetLineChartData('newProduct',2)">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" :class="{active : active_el == 3}" @click="handleSetLineChartData('newRevenue',3)">
    ...
    <el-col :xs="12" :sm="12" :lg="6" class="card-panel-col">
      <div class="card-panel" :class="{active : active_el == 4}" @click="handleSetLineChartData('newOrder',4)">
...
export default {
  ...
  methods: {
    handleSetLineChartData(type, active) {
      this.$emit('handleSetLineChartData', type);
      this.active_el = active;
    },
  },
};
</script>
