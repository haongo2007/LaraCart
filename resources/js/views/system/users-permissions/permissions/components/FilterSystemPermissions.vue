    ...
    <div>
      ...
      <div class="drawer-item">
        <el-row :gutter="20">
          <el-col :span="24">
            <el-button-group>
              <el-button type="primary" icon="el-icon-plus" :disabled="dataLoading" class="filter-item" @click="$router.push({ name: 'PermissionCreate'}).catch(() => {})" />
      ...
      <div class="drawer-item">
        ...
        <el-row :gutter="24">
          <el-col :span="24">
            <el-input v-model="dataQuery.contain" :placeholder="$t('table.keyword')" style="width: 100%;" class="filter-item" @keyup.enter.native="handleFilter" />
          </el-col>
        </el-row>
      </div>
    </div>
