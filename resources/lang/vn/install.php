...
return [
    'info' => [
        'about' => 'BlackCart là một dự án website thương mại điện tử miễn phí cho doanh nghiệp, được xây dựng trên nền tảng Laravel framework (PHP & Mysql).',
        'about_pro' => 'Mã nguồn website thương mại điện tử doành cho doanh nghiệp!',
        'about_us' => '- Để hiểu thêm về chúng tôi, hãy ghé thăm <a target="_new" href="https://black-cart.org/">Trang chủ của BlackCart</a>',
    ...
    'installing_button' => 'Đang cài đặt BlackCart',
